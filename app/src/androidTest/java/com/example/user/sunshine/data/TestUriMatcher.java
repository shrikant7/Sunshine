...
/*
    when we are ready to test your UriMatcher.  Note that this class utilizes
...
public class TestUriMatcher extends AndroidTestCase {
    ...
    // content://com.example.user.sunshine/weather"
    ...
    // content://com.example.user.sunshine/location"
    private static final Uri TEST_LOCATION_DIR = WeatherContract.LocationEntry.CONTENT_URI;

    /*
        This function tests that our UriMatcher returns the correct integer value
